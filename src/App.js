...
var aboutSection = 
  <div className="flexbox-container">
    ...
    Software Development and Cyber Security.</p>
...
var projectSection = 
  <div>
    <div className="grid-container">
      <a href="https://github.com/andrewdibs/OS-2020">
      ...
      <a href="https://github.com/andrewdibs/Capping-2020">
        <div className="grid-item">
      ...
      <a href="https://github.com/andrewdibs/andrewdibs">
        <div className="grid-item">
    ...
    <div className="grid-container">
    <a href="https://github.com/andrewdibs/Oregon">
        <div className="grid-item">
      ...
      <a href="https://github.com/andrewdibs/Algorithms">
        <div className="grid-item">
      ...
      <a href="https://www.youracclaim.com/badges/230a91a9-d333-4c10-ba1b-3ad4978cbda6/linked_in_profile">
        <div className="grid-item">
...
var footnote = 
  <div>
    ...
    <h5>Feel free to contact me through <a href="https://www.linkedin.com/in/andrew-dibella-961289172/">LinkedIn</a> or by phone/email</h5>
    <h6>732-609-3597</h6>
